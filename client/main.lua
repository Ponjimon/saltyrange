...
AddEventHandler('SaltyChat_VoiceRangeChanged', function()
    ...
    CreateThread(function()
        while ShowVoiceRange do
            ...
            DrawMarker(1, PlayerPos.x, PlayerPos.y, PlayerPos.z - 0.95, 0, 0, 0, 0, 0, 0, VoiceRange * 2, VoiceRange * 2, VoiceRange,  SaltyRange.RangeColor.R, SaltyRange.RangeColor.G, SaltyRange.RangeColor.B, SaltyRange.RangeColor.A, false, false, 2, false, nil, nil, false)
